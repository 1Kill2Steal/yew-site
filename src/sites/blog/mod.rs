...
pub fn understanding_big_o_notation() -> Html {
    ...
    // Contents style
    // TODO: Refactor it as a function that takes an array of (string, string) tuples where 0 is
    // the link and 1 is the text and it generates HTML based on that.
    // Why? It's more useful like that.
    let contents = html! {
        <>
